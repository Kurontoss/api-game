 ...
 */
final class Version20251216114026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, value INT NOT NULL, type VARCHAR(255) NOT NULL, hp_regen INT DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE item_instance (id INT AUTO_INCREMENT NOT NULL, amount INT NOT NULL, item_id INT NOT NULL, knight_id INT DEFAULT NULL, INDEX IDX_2E3D7915126F525E (item_id), INDEX IDX_2E3D7915229E98EF (knight_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE item_instance ADD CONSTRAINT FK_2E3D7915229E98EF FOREIGN KEY (knight_id) REFERENCES knight (id)');
        ...
        $this->addSql('ALTER TABLE enemy ADD loot_pool_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item_instance DROP FOREIGN KEY FK_2E3D7915229E98EF');
        ...
        $this->addSql('ALTER TABLE enemy DROP loot_pool_id, CHANGE name name VARCHAR(256) NOT NULL');
